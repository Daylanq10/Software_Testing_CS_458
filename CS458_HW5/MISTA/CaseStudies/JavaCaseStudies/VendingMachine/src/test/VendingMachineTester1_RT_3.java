...
public class VendingMachineTester1_RT_3 {
	...
	public void test2() throws Exception {
		...
		assertTrue("1_1_2_1", checkDrink(JUICE, 110, 0));
		assertTrue("1_1_2_1", checkDrink(SODA, 105, 0));
		assertTrue("1_1_2_1", ! (vendingmachine.getDeposit()==0));
		vendingmachine.returnCoins();
		assertTrue("1_1_2_1_1", vendingmachine.getDeposit()==0);
		assertTrue("1_1_2_1_1", checkDrink(COFFEE, 35, 0));
		assertTrue("1_1_2_1_1", checkDrink(JUICE, 110, 0));
		assertTrue("1_1_2_1_1", checkDrink(SODA, 105, 0));
		assertTrue("1_1_2_1_1", ! (vendingmachine.getDeposit()==25));
	}
	...
	public void test4() throws Exception {
		...
		vendingmachine.insertCoin(Coin.DOLLAR);
		assertTrue("1_2_2_1", vendingmachine.getDeposit()==100);
		assertTrue("1_2_2_1", checkDrink(COFFEE, 35, 0));
		assertTrue("1_2_2_1", checkDrink(JUICE, 110, 0));
		...
		assertTrue("1_2_2_1_1", checkDrink(COFFEE, 35, 0));
		assertTrue("1_2_2_1_1", checkDrink(JUICE, 110, 0));
		assertTrue("1_2_2_1_1", checkDrink(SODA, 105, 0));
		assertTrue("1_2_2_1_1", ! (vendingmachine.getDeposit()==100));
	}
